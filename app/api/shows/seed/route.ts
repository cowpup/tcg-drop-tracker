...
// ============================================================================
// MORE REGIONAL CARD SHOWS - 2026
// Sources: frontrowcardshow.com, eastbaycardshow.com, genesiscardshow.com, etc.
// ============================================================================
const moreRegionalShows: ShowSeed[] = [
  // FRONT ROW CARD SHOW - Multiple Cities
  {
    name: "Front Row Card Show Seattle April 2026",
    organizer: "Front Row Card Show",
    showType: "CARD_SHOW",
    tier: "REGIONAL",
    ...
    lat: 47.2529,
    lng: -122.4443,
    website: "https://frontrowcardshow.com/collections/seattle",
    description: "Sports cards, TCG, comics, toys, video games, memorabilia",
  },
  {
    name: "Front Row Card Show Phoenix June 2026",
    organizer: "Front Row Card Show",
    showType: "CARD_SHOW",
    tier: "REGIONAL",
    startDate: "2026-06-27",
    endDate: "2026-06-28",
    venueName: "State Farm Stadium",
    ...
    lat: 33.5276,
    lng: -112.2626,
    website: "https://frontrowcardshow.com/",
    description: "Arizona's premier sports card and collectibles show",
  },
  {
    name: "Front Row Card Show Las Vegas May 2026",
    organizer: "Front Row Card Show",
    showType: "CARD_SHOW",
    tier: "REGIONAL",
    startDate: "2026-05-02",
    endDate: "2026-05-03",
    venueName: "Rio Hotel & Casino",
    ...
    lat: 36.1167,
    lng: -115.1872,
    website: "https://frontrowcardshow.com/collections/las-vegas",
    description: "Las Vegas trading card and collectibles convention",
  },
  // NORTHEAST SPORTS CARD EXPO
  {
    name: "Northeast Sports Card Expo Quincy March 2026",
    organizer: "Northeast Sports Card Expo",
    showType: "CARD_SHOW",
    tier: "REGIONAL",
    startDate: "2026-03-28",
    endDate: "2026-03-29",
    venueName: "Marriott Boston Quincy",
    address: "1000 Marriott Drive",
    city: "Quincy",
    state: "MA",
    zip: "02169",
    lat: 42.2359,
    lng: -71.0029,
    website: "https://www.northeastcardexpo.com/",
    description: "New England's premier sports card expo",
  },
  {
    name: "Northeast Sports Card Expo Stamford May 2026",
    organizer: "Northeast Sports Card Expo",
    showType: "CARD_SHOW",
    tier: "REGIONAL",
    startDate: "2026-05-02",
    endDate: "2026-05-03",
    venueName: "Chelsea Piers Athletic Club",
    ...
    lng: -73.5387,
    website: "https://www.northeastcardexpo.com/",
    description: "Connecticut sports card expo",
  },
  // EAST BAY CARD SHOW - San Francisco Area
  {
    name: "East Bay Card Show March 2026",
    organizer: "East Bay Card Show",
    showType: "CARD_SHOW",
    tier: "REGIONAL",
    startDate: "2026-03-07",
    endDate: "2026-03-08",
    ...
    lat: 37.4041,
    lng: -121.9750,
    website: "https://www.eastbaycardshow.com/",
    description: "Bay Area's largest trading card show",
  },
  {
    name: "East Bay Card Show April 2026",
    organizer: "East Bay Card Show",
    showType: "CARD_SHOW",
    tier: "REGIONAL",
  ...
  {
    name: "East Bay Card Show June 2026",
    organizer: "East Bay Card Show",
    showType: "CARD_SHOW",
    tier: "REGIONAL",
    startDate: "2026-06-20",
    ...
    lng: -122.3664,
    website: "https://www.eastbaycardshow.com/",
    description: "Bay Area sports card and collectibles show",
  },
  // GENESIS CARD SHOW - Las Vegas
  {
    name: "Genesis Card Show Las Vegas March 2026",
    organizer: "Genesis Card Show",
    showType: "CARD_SHOW",
    tier: "REGIONAL",
    startDate: "2026-03-07",
    endDate: "2026-03-08",
    venueName: "Gold Coast Hotel",
    ...
    lat: 36.1094,
    lng: -115.1892,
    website: "https://www.genesiscardshow.com/",
    description: "Las Vegas sports card and memorabilia show",
  },
  // MINNESOTA CARD SHOW
  {
    name: "Minnesota Card Show April 2026",
    organizer: "Minnesota Card Show",
    showType: "CARD_SHOW",
    tier: "REGIONAL",
    startDate: "2026-04-16",
    endDate: "2026-04-19",
    venueName: "Canterbury Park",
    address: "100 Canterbury Rd",
    city: "Shakopee",
    state: "MN",
    zip: "55379",
    lat: 44.7775,
    lng: -93.5088,
    website: "https://www.cardshowmn.com/",
    description: "Minnesota's largest trading card convention",
  },
  // GREAT LAKES COLLECTORS - Cleveland
  {
    name: "Great Lakes Collectors Convention April 2026",
    organizer: "Greenie Sports Cards",
    showType: "CARD_SHOW",
    tier: "REGIONAL",
    startDate: "2026-04-10",
    endDate: "2026-04-12",
    venueName: "Independence Fieldhouse",
    address: "6354 Selig Dr",
    city: "Independence",
    state: "OH",
    zip: "44131",
    lat: 41.3995,
    lng: -81.6285,
    website: "https://greeniesportscards.com/great-lakes-convention",
    description: "Ohio's premier sports card and memorabilia convention",
  },
  // COLLECT-A-CON CLEVELAND
  {
    name: "Collect-A-Con Cleveland May 2026",
    organizer: "Collect-A-Con",
    showType: "COLLECTACON",
    tier: "MAJOR",
    ...
    lat: 41.5074,
    lng: -81.6937,
    website: "https://collectaconusa.com/cleveland/",
    description: "Collect-A-Con Cleveland with 500+ dealers and celebrities",
    featured: true,
  },
];

// ============================================================================
// MORE POKEMON REGIONALS 2026
// Source: championships.pokemon.com
// ============================================================================
const morePokemonEvents: ShowSeed[] = [
  {
    name: "Seattle Pokemon Regional Championships 2026",
    organizer: "The Pokemon Company",
    showType: "REGIONAL_CHAMPIONSHIP",
    tier: "REGIONAL",
    ...
    lng: -122.3329,
    website: "https://championships.pokemon.com/",
    description: "Pokemon TCG and VGC Regional Championship",
    featured: true,
  },
  {
    name: "Las Vegas Pokemon Regional Championships 2026",
    organizer: "The Pokemon Company",
    showType: "REGIONAL_CHAMPIONSHIP",
    tier: "REGIONAL",
...
// ============================================================================
// MAGIC: THE GATHERING EVENTS 2026
// Source: magic.gg, mtgfestivals.com
// ============================================================================
const mtgEvents: ShowSeed[] = [
  {
    name: "MagicCon Las Vegas 2026",
    ...
    lat: 36.1320,
    lng: -115.1537,
    website: "https://mcvegas.mtgfestivals.com/",
    description: "Magic: The Gathering convention with tournaments, panels, and exclusive products",
    featured: true,
  },
  {
    name: "MagicCon Atlanta 2026",
    organizer: "Wizards of the Coast",
    showType: "OTHER",
    tier: "NATIONAL",
    ...
    lat: 33.7606,
    lng: -84.3963,
    website: "https://mcatlanta.mtgfestivals.com/",
    description: "Magic: The Gathering convention with Pro Tour and Commander events",
    featured: true,
  },
];

// ============================================================================
// YU-GI-OH! CHAMPIONSHIP SERIES 2026
// Source: yugioh-card.com
// ============================================================================
const yugiohEvents: ShowSeed[] = [
  {
    name: "YCS Richmond 2026",
    organizer: "Konami",
    showType: "OTHER",
    tier: "NATIONAL",
    startDate: "2026-02-14",
    endDate: "2026-02-15",
    venueName: "Greater Richmond Convention Center",
    ...
    description: "300th Yu-Gi-Oh! Championship Series event",
    featured: true,
  },
  {
    name: "YCS Columbus 2026",
    organizer: "Konami",
    showType: "OTHER",
    tier: "NATIONAL",
    startDate: "2026-05-23",
    ...
    lng: -83.0019,
    website: "https://www.yugioh-card.com/en/events/",
    description: "Yu-Gi-Oh! Championship Series Columbus",
  },
];

// ============================================================================
// ONE PIECE TCG EVENTS 2026
// Source: en.onepiece-cardgame.com
// ============================================================================
const onePieceEvents: ShowSeed[] = [
  {
    name: "One Piece Championship Finals Las Vegas 2026",
    organizer: "Bandai",
    showType: "OTHER",
    tier: "NATIONAL",
    startDate: "2026-02-14",
    ...
    lat: 36.1320,
    lng: -115.1537,
    website: "https://en.onepiece-cardgame.com/events/",
    description: "One Piece Card Game North America Championship Finals",
    featured: true,
  },
];
